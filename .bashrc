...
source /home/klaasjan/.local/bin/virtualenvwrapper.sh
...
function fix_window_title {
  default_title="\033]0${USER}@${HOSTNAME} ALSKDJALKSDJ ${PWD/#$HOME/~}\007"

  echo -ne $default_title
}
